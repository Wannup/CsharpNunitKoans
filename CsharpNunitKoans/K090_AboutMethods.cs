...
namespace TheKoans
{
	...
	public class K090_AboutMethods : KoanHelper
	{
		...
		{
			Assert.AreEqual (this.MethodWithVariableArguments ("Cory", "Will", "Corey"), this.LocalMethodWithVariableParameters ("Cory", "Will", "Corey"));
		}
		...
		{
			Assert.AreEqual (this.MethodWithVariableArguments ("Cory", "Will", "Corey"), LocalMethodWithVariableParameters ("Cory", "Will", "Corey"));
		}
